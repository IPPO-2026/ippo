...
확인일: **2026-09-19**. 이 문서는 배포 가능한 구성을 설명합니다. 현재 저장소 생성만으로 Cloudflare 서비스나 AI가 활성화되지는 않습니다.
...
현재 제한: 메시지당 1,000자, 최근 최대 8개 메시지·총 3,200자, 출력 최대 384 tokens, 전체 하루 60회, IP별 하루 6회. AI와 앱 일일 제한은 **UTC 00:00 = 한·일 오전 09:00**에 초기화됩니다. 미션의 하루 경계는 선택 지역의 자정입니다.
...
- 대화 내보내기·삭제·저장 선택 해제, 새로고침 후 잔존 여부를 확인합니다.
