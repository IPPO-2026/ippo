export const pwaCopy = {
  ko: {
    ...
    updateWarning: '앱을 새로 열어요. 저장하지 않은 대화와 입력 중인 내용은 사라질 수 있어요. 필요한 내용은 기기 저장을 켜거나 복사해 주세요. 업데이트할까요?',
  ...
  ja: {
    ...
    updateWarning: 'アプリを開き直します。保存していない会話や入力中の内容は消える場合があります。必要な内容は保存をオンにするかコピーしてください。更新しますか？',
